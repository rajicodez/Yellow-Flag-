...
async function extract() {
  ...
  await debugImg.write('monaco_mask_v2_debug.png');

  fs.writeFileSync('monaco_mask_v2_clean.json', JSON.stringify({w, h, mask, minX, minY, maxX, maxY}));
}
