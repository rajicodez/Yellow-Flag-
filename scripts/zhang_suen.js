...
fs.writeFileSync('monaco_skeleton.json', JSON.stringify(pts));

// We now have a clean 1-pixel thick skeleton.
// We just need to traverse it.
// The skeleton might still have small branches (from arrows).
// Let's prune leaf branches!
...
fs.writeFileSync('monaco_loop.json', JSON.stringify(remaining));
